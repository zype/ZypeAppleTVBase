...
class VimeoUrl: BaseUrl, VideoUrl {
    ...
    fileprivate var kPlayerGetVideo:String {
        ...
        /* According to APPS-752, Update the bundle_id being generated by the TOH iOS app to the following value: 1477403391 */
        let appBundle = "1477403391" //Bundle.main.bundleIdentifier
        let deviceType = 7
