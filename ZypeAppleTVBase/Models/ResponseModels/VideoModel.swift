...
open class VideoModel: BaseModel {
    ...
    init(fromJson: Dictionary<String, AnyObject>)
    {
        ...
        do {
            videoTitle = try SSUtils.stringFromDictionary(fromJson, key: kJSONTitle)
        }
        catch _ {
            ZypeLog.error("Exception: VideoModel | Init Video Title")
        }
